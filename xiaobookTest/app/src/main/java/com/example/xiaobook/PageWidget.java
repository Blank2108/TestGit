...
public class PageWidget extends RelativeLayout {
	...
	private int mWidth = 0;// = 480;
	private int mHeight = 0;// 800;
	...
	public boolean bIsShowNoMore;// ����һҳ�����һҳ�ж�
	...
	public boolean bIsTimeRefresh;// �ж��Ƿ���ʱ����Ҫˢ��
 ...
 * 
 */
	public PageWidget(Context context, AttributeSet atr) {
		// TODO Auto-generated constructor stub
		super(context, atr);
		init();
	}
	...
	// public PageWidget(Context context, int mWidth, int mHeight) {
	// super(context);
	// // TODO Auto-generated constructor stub
	// mPath0 = new Path();
	// mPath1 = new Path();
	...
	protected void onFinishInflate() {
		...
		// Log.i("lxm", "33" + getHeight());
		// Log.i("lxm", "33" + getHeight());
		// TextView aa=(TextView)findViewById(R.id.text);
		// aa.setText("fffffffffff");
	...
	public void setcolor(int color) {
		...
		jindu.setTextColor(color);
	}

	public void setjindu(String jindutiao) {
		// timeview.setTextColor(color);
		jindu.setText(jindutiao);
	}
	...
	public void setcurBitmaps(Bitmap bm1) {
		mCurPageBitmap = bm1;
		mNextPageBitmap = bm1;
		bIsUpdata = true;
		invalidate();
	...
	public void onDraw(Canvas canvas) {
		Log.i("lxm", "Draw" + bIsTimeRefresh + "--" + bIsShowNoMore + "--"
				+ bIsUpdata);
		if (bIsTimeRefresh) {
			// Log.i("lxm", "bIsTimeRefresh");
	...
	public void setcolor(int color, Vector<String> mlines) {
		// this.color = color;
		// m_lines = mlines;
		// bIsUpdata = true;
		// this.invalidate();
		// Log.i("lxm222", "" + m_lines.size());
		// Log.i("lxm222", "" + m_lines.toString());
	}
